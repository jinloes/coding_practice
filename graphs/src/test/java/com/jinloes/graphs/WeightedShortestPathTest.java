...
class WeightedShortestPathTest {
    ...
    void findShortestPath_simpleGraph() {
        ...
        assertThat(WeightedShortestPath.findShortestPath(graph, "A", "B")).isEqualTo(List.of("A", "B"));
    }
    ...
    void findShortestPath_complexGraph() {
        ...
        assertThat(WeightedShortestPath.findShortestPath(graph, "A", "D")).isEqualTo(List.of("A", "C", "D"));
    }
    ...
    void findShortestPath_complexGraph_alternateWeights() {
        ...
        assertThat(WeightedShortestPath.findShortestPath(graph, "A", "D")).isEqualTo(List.of("A", "B", "D"));
    }
    ...
    void findShortestPath_veryComplexGraph() {
        ...
        assertThat(WeightedShortestPath.findShortestPath(graph, "A", "G"))
    ...
    void findShortestPath_emptyGraph() {
        DefaultDirectedWeightedGraph<String, DefaultWeightedEdge> graph = new DefaultDirectedWeightedGraph<>(DefaultWeightedEdge.class);
        assertThat(WeightedShortestPath.findShortestPath(graph, "A", "B")).isEmpty();
    }
    ...
    void shortestPathBfs_simpleGraph() {
        ...
        assertThat(WeightedShortestPath.shortestPathBfs(graph, "A", "B")).isEqualTo(List.of("A", "B"));
    }
}