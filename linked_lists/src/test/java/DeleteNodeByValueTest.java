...
public class DeleteNodeByValueTest {
    ...
    @Test
    void deleteNode() {
        assertThat(DeleteNodeByValue.deleteNodeByValue(n1, 2)).isEqualTo(n1);
    ...
    void deleteHeadNode() {
        ...
        assertThat(DeleteNodeByValue.deleteNodeByValue(n1, 1)).isEqualTo(n2);
    ...
    void deleteTailNode() {
        ...
        assertThat(DeleteNodeByValue.deleteNodeByValue(n1, 3)).isEqualTo(n1);
