...
public class LcaBinaryTree {
    ...
    public BinaryTreeNode<Integer> lca(BinaryTreeNode<Integer> root, BinaryTreeNode<Integer> first,
        ...
        if (Objects.equals(root.data, first.data) || Objects.equals(root.data, second.data)) {
            return root;
        }

        BinaryTreeNode<Integer> left = lca(root.left, first, second);
        BinaryTreeNode<Integer> right = lca(root.right, first, second);
